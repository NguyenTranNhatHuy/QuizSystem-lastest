...
<html>
    <head>
        ...
        <section style="margin-top: 30px">
            ...
            <form style="margin: 20px auto; width: 75% " action="searchServlet" method="post">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Search for Collection"  name="txt" value="${s}">
